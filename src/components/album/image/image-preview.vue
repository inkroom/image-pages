        ...
        <transition name="fade">
            <div class="ivu-image-preview-wrap" v-if="modelValue" :style="maskStyle">
                <div class="ivu-image-preview" v-bind="$attrs" @click.stop="handleClickMask">
                    ...
                    <div v-if="status === 'failed'" class="ivu-image-preview-fail">
                        <span>{{ failLang }}</span>
                    </div>
                    <img
                        :class="imgClasses"
...
<script>
    ...
    import { isClient } from 'view-ui-plus/src/utils';
    import Locale from 'view-ui-plus/src/mixins/locale';
    import KeyCode from 'view-ui-plus/src/utils/keyCode';
    import { transferIndex, transferIncrease } from 'view-ui-plus/src/utils/transfer-queue';
    import { downloadFile } from 'view-ui-plus/src/utils/assist';

    export default {
        name: 'InkImagePreview',
        mixins: [ Locale ],
        inheritAttrs: false,
